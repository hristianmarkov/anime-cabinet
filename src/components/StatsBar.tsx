...
const staticStats = [
  ...
  { value: `${site.deliveryHours} Hours`, label: "Standard delivery" },
...
export function StatsBar() {
  ...
  return (
    <section className="border-y border-line bg-ink-soft">
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-4 px-4 py-8 sm:px-6 lg:grid-cols-4 lg:gap-6 lg:py-10">
        {stats.map((s) => (
