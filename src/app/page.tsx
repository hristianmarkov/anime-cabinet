...
export const metadata: Metadata = {
  ...
  description:
    "Turn your photo into a custom anime or cartoon portrait. 30+ styles — Naruto, One Piece, Ghibli, Simpsons & more. Unlimited revisions, preview within 48 hours.",
...
const steps = [
  {
    ...
    body: "Choose from 30+ anime and cartoon styles — from Naruto to The Simpsons. Select how many people (and pets) you want drawn, your background, and digital or print.",
  },
  {
...
const occasions = [
  ...
  {
    title: "Birthdays",
    body: "Skip the gift card. Give them their own wanted poster, trading card or Saiyan transformation instead.",
    accent: "#ffc53d",
  },
  {
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-4 pb-12 pt-10 sm:px-6 lg:grid-cols-2 lg:gap-10 lg:pb-16 lg:pt-14">
          <div>
            ...
            <p className="mt-4 max-w-xl text-lg leading-relaxed text-muted">
              ...
              30+ styles, unlimited revisions, delivered within {site.deliveryHours}{" "}
              hours.
            </p>
