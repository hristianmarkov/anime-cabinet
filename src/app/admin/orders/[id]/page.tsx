    ...
    <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-xs text-faint break-all">{order.id}</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <form action={logout}>
            <button
              type="submit"
              className="rounded-full border border-line px-4 py-2 text-sm text-muted hover:text-cream"
            >
              Log out
            </button>
          </form>
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-8">
          <article className="rounded-2xl border border-line bg-surface p-6 shadow-card">
            ...
            <form action={updateOrderStatus} className="mt-6 flex flex-wrap items-center gap-2 border-t border-line pt-4">
        ...
        <aside className="rounded-2xl border border-line bg-surface p-6 shadow-card h-fit">
              ...
              {timeline.map((event) => (
                <li key={event.id} className="flex gap-3">
                  ...
                  <div>
                    ...
                    {event.detail && (
                      <p className="mt-1 text-xs text-muted whitespace-pre-wrap">{event.detail}</p>
                    )}
